...
ResultSet rs=st.executeQuery("select * from question where Question like '%"+Keyword+"%'");
if(!rs.next()){
	out.println("NO question relates to this keyword!");
}
else{
%>
<h2>Search Result</h2>
...
<% 
	...
	rs=st.executeQuery("select * from question where Question like '%"+Keyword+"%'");
	while(rs.next()){ 
