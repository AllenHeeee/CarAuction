...
ResultSet rs=st.executeQuery("select * from question where AuctionID = '"+AuctionID+"'");
if(!rs.next()){
	out.println("This Auction ID does not exist or NO question relates to this auction!");
}
else{
%>
...
<% 
	...
	rs=st.executeQuery("select * from question where AuctionID = '"+AuctionID+"'");
	while(rs.next()){ 
